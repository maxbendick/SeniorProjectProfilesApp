...
const ProfileHeader = ({profile, updateFavorites}) => {
    return (
        <Flexbox id="profile-header" flexDirection="row" alignItems="flex-start" style={{padding: "20px"}}>
            ...
            <Flexbox marginRight="30px" flexGrow={1} flexDirection="row" justifyContent="flex-end">
                <FavoriteStar profile={profile} handleStarChange={() => updateFavorites({profile})} />
            </Flexbox>
        </Flexbox>
    );
};
...
const Profile = ({profile, updateFavorites}) => {
    return (
        <Flexbox style={{justifyContent: "center"}}>
            <Paper style={{maxWidth: "700px", marginTop: "20px"}} zDepth={1}>
                <Flexbox flexDirection="column">
                    <ProfileHeader profile={profile} updateFavorites={updateFavorites}/>
                    <Divider />
...
const ProfileAppInputForm = (props) => {
    const params = {name: "", company: "", twitter: ""};
...
export const ProfileAppRouteAdapter = ({updateFavorites}) => {
    return location.search
        ? <ProfileApp params={queryString.parse(location.search)} 
                      googleProfile={false} 
                      updateFavorites={updateFavorites}/>
        : <ProfileAppInputForm />
}

export const GoogleProfileAppRouteAdapter = ({match}) => {
    return (
